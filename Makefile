...
black: ## run black
	black --config pyproject.toml setup.py src/kiara_plugin/tropy tests

flake: ## check style with flake8
	flake8 src/kiara_plugin/tropy tests

mypy: ## run mypy
	mypy  --namespace-packages --explicit-package-base src/kiara_plugin/tropy
