...
"""Top-level package for kiara_plugin.tropy."""
...
KIARA_METADATA = {
    ...
    "references": {
        "source_repo": {
            ...
            "url": "https://github.com/DHARPA-Project/kiara_plugin.tropy",
        },
        "documentation": {
            "desc": "The url for the module package documentation.",
            "url": "https://DHARPA-Project.github.io/kiara_plugin.tropy/",
        },
    },
    "tags": ["tropy"],
    "labels": {"package": "kiara_plugin.tropy"},
}

find_modules: KiaraEntryPointItem = (
    find_kiara_modules_under,
    "kiara_plugin.tropy.modules",
)
find_model_classes: KiaraEntryPointItem = (
    find_kiara_model_classes_under,
    "kiara_plugin.tropy.models",
)
find_data_types: KiaraEntryPointItem = (
    find_data_types_under,
    "kiara_plugin.tropy.data_types",
)
find_pipelines: KiaraEntryPointItem = (
    find_pipeline_base_path_for_module,
    "kiara_plugin.tropy.pipelines",
    KIARA_METADATA,
)
